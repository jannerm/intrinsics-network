...
path=logs_generalize/category_single-transfer-motorbike_airplane_
            ...
            do
                ...
                do
                    ...
                    sbatch  -c 6 --qos=tenenbaum --gres=gpu:titan-x:1 --mem=60G --time=3-12:0 -J ${lr}_${lab_mult} composer.py \
                            ...
                            --decomposer components/vector_depth_state_decomp_motorbike_vector_0.01lr_1lights/state.t7 \
                            --unlabeled airplane_vector --labeled motorbike_vector \
                            --val_sets airplane_vector \
